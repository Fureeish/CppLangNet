...
import FullCode_UsingAProjectionToFindAValueWithAGivenCharacteristic2            from './_codes/find/example-Using-a-projection-to-find-a-value-with-a-given-characteristic1.mdx';
